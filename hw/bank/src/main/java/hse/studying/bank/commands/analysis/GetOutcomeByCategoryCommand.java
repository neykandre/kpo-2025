...
@Validated
public class GetOutcomeByCategoryCommand implements Command<Map<Category, List<Operation>>> {
    ...
    public Map<Category, List<Operation>> execute() {
        return analysisFacade.getOutcomeByCategory(bankAccount, startDate, endDate);
    }
}
